-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('ACTIVE', 'SUSPENDED', 'RESTRICTED');
...
CREATE TABLE "ClassSubject" (
    ...
    CONSTRAINT "ClassSubject_pkey" PRIMARY KEY ("classLevelId","subjectId")
);
...
-- AddForeignKey
ALTER TABLE "StudentProfile" ADD CONSTRAINT "StudentProfile_academicSessionId_fkey" FOREIGN KEY ("academicSessionId") REFERENCES "AcademicSession"("id") ON DELETE SET NULL ON UPDATE CASCADE;
